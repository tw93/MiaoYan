...
enum Theme {
    ...
    enum Metrics {
        ...
        /// Optical vertical offset for sidebar row content. Sidebar cell views
        /// are flipped, so a positive value moves the label and icon downward.
        static let sidebarContentOffsetY: CGFloat = 1.5
