...
1. 从 <a href="https://github.com/tw93/MiaoYan/releases" target="_blank">GitHub Releases</a> 中 **下载** 最新的 MiaoYan.dmg 安装包，双击安装即可，如安装出现问题请参考 [文档](https://zhuanlan.zhihu.com/p/52389383)，此外妙言也支持 `brew install miaoyan --cask` 安装。
