...
1. 从 <a href="https://github.com/tw93/MiaoYan/releases" target="_blank">GitHub Releases</a> 中 **下载** 最新的 dmg 安装包，如安装出现问题请参考 [文档](https://zhuanlan.zhihu.com/p/52389383)，此外也支持从 `brew install miaoyan --cask` 安装。
